	...
	<c:forEach var="dto" items="${list}">
        <div class="col-lg-4 col-sm-6 portfolio-item" style="background-color: #c1c1c1;">
          <div class="card h-100" style="background-color: #c1c1c1;">
            ...
            <a href="javascript:manuread('${dto.num}')"><img class="img-responsive btn-block" src="${root}/view/storage/${dto.filename}" alt="" 
            style='height: 100%; object-fit: contain'></a>
            </div>
            <div class="card-body" style="background-color: #c1c1c1;">
              <h5 class="card-title" style="background-color: #c1c1c1;">
...
<!--       <div class="row" style="background-color: #c1c1c1;"> -->
<!--         <div class="col-lg-12 mb-12"> -->
<!--       	<h4 class="my-4">생산설비</h4> -->
<!--       	</div> -->
<%--       	 <c:forEach var="dto" items="${faclist}" begin = "0" end = "1"> --%>
<!--         <div class="col-lg-6 mb-6"> -->
<!--           <div class="card h-100" style="background-color: #c1c1c1;"> -->
<%--             <h5 class="card-header"><a href="javascript:manuread('${dto.num}')">${dto.subject}</a> --%>
<!--             </h5> -->
<!--             <div class="card-body"> -->
<%--               <a href="javascript:manuread('${dto.num}')"><img class="img-responsive btn-block" src="${root}/view/storage/${dto.filename}" alt=""  --%>
<!--             style='height: 100%; object-fit: contain'></a> -->
      ...
      <div class="row" style="background-color: #c1c1c1;">
        ...
        <div class="col-lg-6 mb-6">
		  ...
		  src="https://www.google.com/maps/embed/v1/place?key=AIzaSyB1g5EiwyP2I7Eb0SoizibNfqlubQnBxTs
            ...
            <input type = "button" class="align-right btn btn-default" onclick="${root}/main/map.do" value="더보기">
            </div>
