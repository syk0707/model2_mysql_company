  ...
  <body>
    ...
    <div class="container">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">가공 상세페이지</li>
      </ol>
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          <img class="img-fluid" src="<%=root %>/images/1.jpg" alt="">
        </div>

        <div class="col-md-4">
          <h5 class="my-3">문래동 치면 연삭 전문<br> 금명정밀기어(DP5*스퍼기어 치연삭)</h5>
          <p>DP5*스퍼기어 치연삭</p>
          <h5 class="my-3">모든 기어 관련 문의, <br>친절히 상담해드리겠습니다.<br> 감사합니다</h5>
          <ul>
          </ul>
        </div>
