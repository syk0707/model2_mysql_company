  ...
  <body>
    ...
    <div class="container">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">경영철학</li>
      </ol>
      ...
      <div class="row">
        ...
        <div class="col-lg-3 mb-4">
          <div class="list-group">
            <a href="<%=root %>/view/ceo.jsp" class="list-group-item">CEO인사말</a>
            <a href="<%=root %>/view/history.jsp" class="list-group-item">연혁</a>
            <a href="<%=root %>/view/philosophy.jsp" class="list-group-item">경영철학</a>
            <a href="<%=root %>/view/map.jsp" class="list-group-item">오시는길</a>
          </div>
        </div>
        <!-- Content Column -->
