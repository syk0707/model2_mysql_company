...
<%@ page import="java.util.*, model.kmbbs.*, utility.*"%>
...
<body>
	...
	<div class="container">
		...
		<ol class="breadcrumb">
			<li class="breadcrumb-item"><a href="${root}/index.do">홈</a></li>
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="container">
					<br>
					<h2>
						<span class="glyphicon glyphicon-th-list"></span> 공지목록
					</h2>
									...
									<tbody>
										<tr>
											...
											<td><c:if test="${dto.indent>0}">
												...
												</c:if> <a href="javascript:read('${dto.num}')">${dto.subject}</a>
