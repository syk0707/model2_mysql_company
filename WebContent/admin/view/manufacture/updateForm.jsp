<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page import="model.kmmanufacture.*, utility.*"%>
...
<body>
	<div id="page-wrapper">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">가공 정보 수정</h1>
			</div>
			<!-- /.col-lg-12 -->
		</div>
		<!-- /.row -->
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">가공 정보 입력</div>
							...
							<div class="row">
								<div class="col-lg-8">
									<div class="form-group">
										<label>글쓴이</label> <input type="text" name="name"
									...
									<div class="form-group">
										<label>부제</label> <input type="text" name="subtitle"
											class="form-control" value="${dto.subtitle}"
											>
									</div>
									<div class="form-group">
										<label>내용</label>
									...
									<div class="form-group">
										<label>대표사진</label> <input type="file" name="filename">${dto.filename}
									</div>
									<div class="form-group">
										<label>가공분류</label> <select name="producttype"
											class="form-control">
											...
											<option value="치절웜">기어치절웜기어</option>
										      ...
										      document.frm.producttype.value='${dto.producttype}';
										      </script>
									</div>
									<div class="form-group">
									...
									<input type="submit" class="btn btn-default" value="전송" /> <input
										type="reset" class="btn btn-default" value="재작성" />
								</div>
